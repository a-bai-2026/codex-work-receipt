...
const RECEIPT_COPY = {
  "zh-CN": {
    ...
    office: {
      ...
      moodReceiptPlanned: "情绪小票功能正在规划中",
      badgesPlanned: "勋章系统正在规划中",
      commandToggleTitle: "查看更多命令行功能",
      printerCommandTitle: "打开更多命令行功能",
      feedbackButton: "意见反馈",
      feedbackTitle: "意见反馈",
      ...
      changelogKicker: "SHIFT LOG / 值班日志",
      changelogText: "查看回执所最近发生了什么 →",
      githubKicker: "BEFORE YOU LEAVE / 支持项目",
      githubText: "离开前，替回执所点亮一颗星 ★",
      sponsorKicker: "本所物资补给",
      sponsorOffer: "可解锁 0.015x GPT 专享分组",
      todayPackKicker: "TODAY'S RECEIPT PACK",
      todayPackTitle: "今日回执包",
      workReceipt: "打工小票",
      workReceiptDescription: "当前正在查看",
      delivered: "已送达",
      moodReceipt: "情绪小票",
      moodReceiptDescription: "了解今天的 AI 情绪",
      currentBadges: "本次勋章",
      currentBadgesDescription: "达到指标后解锁",
      enterTicketHouse: "进入小票屋",
      viewBadgeWall: "查看勋章墙",
      commandDrawerAria: "更多命令行功能",
      commandDrawerCompact: "命令",
      commandDescription: "{count} 条可复制的小票命令。可生成不同范围的小票、设置自动保存或安装票仔。",
  ...
  en: {
    ...
    office: {
      ...
      moodReceiptPlanned: "Mood Receipt is planned for a future version",
      badgesPlanned: "The badge system is planned for a future version",
      commandToggleTitle: "View more CLI features",
      printerCommandTitle: "Open more CLI features",
      ...
      changelogKicker: "SHIFT LOG / CHANGELOG",
      changelogText: "See what changed at the Receipt Office →",
      githubKicker: "BEFORE YOU LEAVE / SUPPORT",
      githubText: "Light a star for the Receipt Office on GitHub ★",
      sponsorKicker: "OFFICE SUPPLIES",
      sponsorOffer: "Unlock 0.015x GPT exclusive group",
      todayPackKicker: "TODAY'S RECEIPT PACK",
      todayPackTitle: "Today's Receipt Pack",
      workReceipt: "Work Receipt",
      workReceiptDescription: "Currently viewing",
      delivered: "Arrived",
      moodReceipt: "Mood Receipt",
      moodReceiptDescription: "Discover today's AI mood",
      currentBadges: "Badges",
      currentBadgesDescription: "Unlock when milestones are reached",
      enterTicketHouse: "Open Ticket House",
      viewBadgeWall: "View Badge Wall",
      commandDrawerAria: "More CLI features",
      commandDrawerCompact: "CLI",
      commandDescription: "{count} copyable commands for receipt ranges, automatic saving, and Ticket Buddy setup.",
